...
for (my $i=0; $i<$nrows; $i++){
	for (my $j=0; $j<$ncols; $j++){
		...
		foreach my $line (@lines){
			...
			my ($rx1, $ry1) = rotate($x1, $y1, $overall_rotation_angle);
			my ($rx2, $ry2) = rotate($x2, $y2, $overall_rotation_angle);
			($x1, $y1) = ($rx1, $ry1);
			($x2, $y2) = ($rx2, $ry2);
