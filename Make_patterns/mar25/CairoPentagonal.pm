...
push @lines, [$points[6], $points[9]];
	...
	my @translation_1 = ($trans_factor*($points[5]->[0] - $points[0]->[0]), $trans_factor*($points[5]->[1] - $points[0]->[1]));
	my @translation_2 = ($trans_factor*($points[7]->[0] - $points[0]->[0]), $trans_factor*($points[7]->[1] - $points[0]->[1]));
